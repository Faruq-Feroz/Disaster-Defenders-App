  ...
  return (
    <header id="header" className={`${styles.header} container`}>
      <a href="#" className={styles.logo}>
        ...
        <h1 className={styles.heading}>Disaster <span style={{color:"#D53827"}}>Defenders</span></h1>
      </a>
      ...
      <div className={styles.end}>
        ...
        {/* New Icons for Notifications and User */}
        <button className={styles.iconButton} aria-label="notifications" title="Notifications">
          <FaBell />
        </button>
        <button className={styles.iconButton} aria-label="user profile" title="User Profile">
          <FaUserCircle />
        </button>
